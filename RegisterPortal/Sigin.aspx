...
<asp:Content ContentPlaceHolderId="CPH1" runat="server">
    <form runat="server">
        ...
        <br/>
        <br/>
        <asp:GridView ID="GridView1" runat="server" CssClass="table table-hover" Class="col-xs-12 col-md-8" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" DataSourceID="SqlDataSource1" Width="766px" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" DataKeyNames="Id" OnRowUpdating="GridView1_RowUpdating">
            <Columns>
